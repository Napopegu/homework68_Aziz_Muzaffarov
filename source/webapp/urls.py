...
from webapp.views import ArticleLikesView, IndexView, ArticleCreateView, ArticleView, ArticleUpdateView, ArticleDeleteView, \
...
urlpatterns = [
    ...
    path('article/<int:pk>/like/', ArticleLikesView.as_view(), name = 'article_like')
]
